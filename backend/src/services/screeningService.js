...
function getConditionSignature(condition, symptoms, labs) {
  const KNOWN_SYMPTOMS = [
    "fatigue", "hair_fall", "weakness", "weight_gain", "weight_loss", "irregular_cycles", "acne", 
    "heat_intolerance", "cold_intolerance", "palpitations", "increased_appetite", "excessive_sweating", 
